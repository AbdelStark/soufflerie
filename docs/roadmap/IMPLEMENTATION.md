...
- Total issues: 69
- Current state: 69 open, 0 closed
...
|---|---|---|---|---|---|---|
| #2 | [foundation: scaffold the typed package and dependency profiles](https://github.com/AbdelStark/soufflerie/issues/2) | foundation | p0 | l | RFC-0001 | open |
| #3 | [foundation: define canonical schemas and artifact identities](https://github.com/AbdelStark/soufflerie/issues/3) | foundation | p0 | l | RFC-0001 | open |
| #4 | [foundation: implement strict configuration and schema export](https://github.com/AbdelStark/soufflerie/issues/4) | foundation | p0 | m | RFC-0001, RFC-0004 | open |
...
| #6 | [solver: implement D2Q9 configuration and NumPy oracle](https://github.com/AbdelStark/soufflerie/issues/6) | solver | p0 | m | RFC-0002 | open |
| #7 | [solver: implement deterministic collision and pull-stream kernels](https://github.com/AbdelStark/soufflerie/issues/7) | solver | p0 | l | RFC-0002 | open |
| #8 | [solver: add lifecycle, diagnostics, and time averaging](https://github.com/AbdelStark/soufflerie/issues/8) | solver | p0 | l | RFC-0002 | open |
| #9 | [solver: verify channel, conservation, and determinism gates](https://github.com/AbdelStark/soufflerie/issues/9) | solver | p0 | l | RFC-0002 | open |
...
| #47 | [observability: implement events, metrics, timers, and redaction](https://github.com/AbdelStark/soufflerie/issues/47) | observability | p0 | l | RFC-0012 | open |
