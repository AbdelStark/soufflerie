...
diameter is `D_lu = 0.125 * ny`. Scale changes the major semi-axis, aspect ratio changes the
...
`512 x 256` grid, the smallest public ellipse (`aspect_ratio=0.5`, `scale=0.75`) has exactly
...
the canonical grid unchanged rather than weakening numerical acceptance or changing blockage.
