...
REQUIRED_WHEEL_MEMBERS = {
    ...
    "soufflerie/demo/__init__.py",
    "soufflerie/demo/rendering.py",
    "soufflerie/demo/ui.py",
    ...
    "soufflerie/schemas/v1/solve-event.json",
    ...
    "soufflerie/service/admission.py",
    "soufflerie/service/app.py",
    "soufflerie/service/contracts.py",
    "soufflerie/service/jobs.py",
    "soufflerie/service/remote.py",
...
REQUIRED_SDIST_MEMBERS = {
    ...
    "schemas/v1/solve-event.json",
    "src/soufflerie/__init__.py",
    "src/soufflerie/demo/__init__.py",
    "src/soufflerie/demo/rendering.py",
    "src/soufflerie/demo/ui.py",
    "src/soufflerie/py.typed",
    "src/soufflerie/service/admission.py",
    "src/soufflerie/service/remote.py",
    "infra/service_execution.py",
    ...
    "tests/service/test_jobs.py",
    "tests/service/test_openapi.py",
    "tests/service/test_remote_jobs.py",
    "tests/service/test_schemas.py",
    "tests/service/test_sse.py",
    "tests/security/test_rate_limits.py",
    "tests/security/test_readiness.py",
    "tests/security/test_admission.py",
